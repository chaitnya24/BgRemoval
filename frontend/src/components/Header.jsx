...
const Header = () => {
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      {/* {left side} */}
      <div>
        <h1 className='text-4xl xl:text-5xl 2xl:text-6x1 font-bold text-neutral-700 leading-tight'>
        ...
        <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. <br className='max-sm:hidden' /> Perspiciatis ratione iste ad optio eveniet cum, vero nostrum numquam itaque omnis reiciendis minus debitis ut, qui obcaecati aut quam suscipit nemo?</p>
        <div>
